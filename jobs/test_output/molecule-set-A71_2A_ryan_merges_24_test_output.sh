...
#SBATCH --job-name=A71EV2A_ryan_merges_24_test_output
...
export INPUT="/opt/xchem-fragalysis-2/kfieseler/EV-A71-2A-syndirella-run-2/syndirella_input/test_output/molecule-set-A71_2A_ryan_merges_24.csv";
export OUTPUT="/opt/xchem-fragalysis-2/kfieseler/A71EV2A_test_aug_2024/molecule-set-A71_2A_ryan_merges_24";
...
echo "Running molecule-set-A71_2A_ryan_merges_24.csv";
