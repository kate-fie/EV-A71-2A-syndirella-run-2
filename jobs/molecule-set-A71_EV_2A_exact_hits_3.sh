...
#SBATCH --job-name=A71EV2A_exact_hits_3
...
export INPUT="/opt/xchem-fragalysis-2/kfieseler/EV-A71-2A-syndirella-run-2/syndirella_input/molecule-set-A71_EV_2A_exact_hits_3.csv";
export OUTPUT="/opt/xchem-fragalysis-2/kfieseler/A71EV2A_run5/molecule-set-A71_EV_2A_exact_hits_3";
...
echo "Running molecule-set-A71_EV_2A_exact_hits_3.csv";
