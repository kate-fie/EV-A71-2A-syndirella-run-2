...
#SBATCH --job-name=Knitwork_June_9_redone
...
export INPUT="/opt/xchem-fragalysis-2/kfieseler/EV-A71-2A-syndirella-run-2/syndirella_input/A71EV2A_Knitwork_June_9_redone.csv";
export OUTPUT="/opt/xchem-fragalysis-2/kfieseler/A71EV2A_run5/A71EV2A_Knitwork_June_9_redone";
...
echo "Running A71EV2A_Knitwork_June_9_redone.csv";
